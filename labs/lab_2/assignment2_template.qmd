...
- What elderly population threshold did you choose and why?  【I choose 15% of total population aged 65 or older as elderly population. The reason it that the percentage of aged poeple of whole country was about 17%.】
...
vuln_with_county <- st_join(
  ...
  pa_counties_proj %>% dplyr::select(county_geoid = FIPS_COUNT, county_name = COUNTY_NAM),
